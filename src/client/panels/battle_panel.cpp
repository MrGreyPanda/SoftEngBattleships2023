...
void BattlePanel::init() {
    ...
    turn_message_text_ = new SDLGui::TextWidget(
        "turn_message_text", "", 0, .0f, .9f, .3f, .1f, 0.,
     ...
     * player has placed
     */
    ship_widget_arr_[4] = new SDLGui::DraggableImageWidget(
        "carrier_ship", "../assets/carrier.bmp", .6f, .2f, .3f, .12f, 0., 5, 1,
    ...
    ship_widget_arr_[3] = new SDLGui::DraggableImageWidget(
        "battleship_ship", "../assets/battleship.bmp", .6f, .35f, .25f, .1f,
        0., 4, 1,
        SDLGui::DraggableImageFlagsExt_CenterImage |
            SDLGui::DraggableImageFlagsExt_NoBackground);
    battle_panel_context->addWidget(ship_widget_arr_[3]);

    ship_widget_arr_[2] = new SDLGui::DraggableImageWidget(
        "cruiser_ship", "../assets/cruiser.bmp", .6f, .5f, .2f, .08f, 0., 3, 1,
        SDLGui::DraggableImageFlagsExt_CenterImage |
            SDLGui::DraggableImageFlagsExt_NoBackground);
    battle_panel_context->addWidget(ship_widget_arr_[2]);

    ship_widget_arr_[1] = new SDLGui::DraggableImageWidget(
        "submarine_ship", "../assets/submarine.bmp", .6f, .65f, .2f, .08f, 0.,
        3, 1,
        SDLGui::DraggableImageFlagsExt_CenterImage |
            SDLGui::DraggableImageFlagsExt_NoBackground);
    battle_panel_context->addWidget(ship_widget_arr_[1]);

    ship_widget_arr_[0] = new SDLGui::DraggableImageWidget(
        "destroyer_ship", "../assets/destroyer.bmp", .6f, .8f, .15f, .06f, 0.,
        2, 1,
        SDLGui::DraggableImageFlagsExt_CenterImage |
            SDLGui::DraggableImageFlagsExt_NoBackground);
...
// ----------------------------- Enemy Ship Widgets -----------------------------
    enemy_ship_widget_arr_[4] =
        new SDLGui::DraggableImageWidget(
            "enemy_carrier_ship", "../assets/carrier_red.bmp", .0f, .0f, .0f, .0f, 0.,
            5, 1,
            SDLGui::DraggableImageFlagsExt_CenterImage |
                SDLGui::DraggableImageFlagsExt_NoBackground);
    ...
    enemy_ship_widget_arr_[3] =
        new SDLGui::DraggableImageWidget(
            "enemy_battleship_ship", "../assets/battleship_red.bmp", .0f, .0f, .0f,
            .0f, 0., 4, 1,
            SDLGui::DraggableImageFlagsExt_CenterImage |
                SDLGui::DraggableImageFlagsExt_NoBackground);
    ...
    enemy_ship_widget_arr_[2] =
        new SDLGui::DraggableImageWidget(
            "enemy_cruiser_ship", "../assets/cruiser_red.bmp", .0f, .0f, .0f, .0f, 0.,
            3, 1,
            SDLGui::DraggableImageFlagsExt_CenterImage |
                SDLGui::DraggableImageFlagsExt_NoBackground);
    ...
    enemy_ship_widget_arr_[1] =
        new SDLGui::DraggableImageWidget(
            "enemy_submarine_ship", "../assets/submarine_red.bmp", .0f, .0f, .0f, .0f,
            0., 3, 1,
            SDLGui::DraggableImageFlagsExt_CenterImage |
                SDLGui::DraggableImageFlagsExt_NoBackground);
    ...
    enemy_ship_widget_arr_[0] =
        new SDLGui::DraggableImageWidget(
            "enemy_destroyer_ship", "../assets/destroyer_red.bmp", .0f, .0f, .0f, .0f,
            0., 2, 1,
            SDLGui::DraggableImageFlagsExt_CenterImage |
                SDLGui::DraggableImageFlagsExt_NoBackground);
