...
void PreparationPanel::render() {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        // ATTENTION -> I think SDL and cpp are handling x y differently, so
        // I'm swapping them here Okey, sometimes, it just isn't working
        // correctly when checking but I'm too tired to check why
