...
bool GameInstanceManager::get_game_instance(const std::string& game_id, GameInstance *&game_instance_ptr) {
...
bool GameInstanceManager::add_player_to_any_game(player *player, GameInstance*& game_instance_ptr, std::string& err) {
...
bool GameInstanceManager::add_player(player *player, GameInstance *&game_instance_ptr, std::string& err) {
    if (player->get_game_id() != "") {
...
bool GameInstanceManager::try_remove_player(player *player, const std::string& game_id, std::string &err) {
