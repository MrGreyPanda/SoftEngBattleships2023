...
public:
    ...
    /**
     * @brief Adds new player to the player list or retrieves the existing player if present.
     * 
     * @param player_id 
     * @param player_ptr 
     */
    static bool add_or_get_player(const std::string& player_id, Player*& player_ptr);
    /**
