...
TEST(OwnBoardTest, PlaceShip){
    ...
    EXPECT_EQ(5, board.get_grid_value(std::make_pair(0, 0)));
    EXPECT_EQ(5, board.get_grid_value(std::make_pair(0, 1)));
    EXPECT_EQ(5, board.get_grid_value(std::make_pair(0, 2)));
    EXPECT_EQ(5, board.get_grid_value(std::make_pair(0, 3)));
    EXPECT_EQ(5, board.get_grid_value(std::make_pair(0, 4)));
    ...
    EXPECT_EQ(2, board.get_grid_value(std::make_pair(2, 2)));
    EXPECT_EQ(2, board.get_grid_value(std::make_pair(3, 2)));
}
...
TEST(OwnBoardTest, RotateShip){
    ...
    EXPECT_EQ(5, board.get_grid_value(std::make_pair(0, 4)));
    EXPECT_TRUE(board.rotate_ship(coords, ship));
    EXPECT_TRUE(board.place_ship(coords, ship));
    EXPECT_EQ(1, coords[1].first);
    EXPECT_EQ(5, board.get_grid_value(std::make_pair(0, 0)));
    EXPECT_EQ(0, board.get_grid_value(std::make_pair(0, 1)));
    EXPECT_EQ(0, board.get_grid_value(std::make_pair(0, 3)));
    EXPECT_EQ(5, board.get_grid_value(std::make_pair(3, 0)));
    EXPECT_EQ(5, board.get_grid_value(std::make_pair(4, 0)));
    coords.clear();
    coords.push_back(std::make_pair(2, 2));
    coords.push_back(std::make_pair(3, 2));
    coords.push_back(std::make_pair(4, 2));
    ...
    EXPECT_EQ(2, board.get_grid_value(std::make_pair(2, 2)));
    EXPECT_EQ(2, board.get_grid_value(std::make_pair(3, 2)));
    EXPECT_EQ(2, board.get_grid_value(std::make_pair(4, 2)));
    EXPECT_EQ(3, coords.size());
    EXPECT_EQ(2, coords[0].first);
    EXPECT_TRUE(board.rotate_ship(coords, Submarine));
    EXPECT_TRUE(board.place_ship(coords, Submarine));
    EXPECT_EQ(0, board.get_grid_value(std::make_pair(3, 2)));
    EXPECT_EQ(2, board.get_grid_value(std::make_pair(2, 3)));
